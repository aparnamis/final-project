...
function Main(){
    ...
    useEffect(()=>{
        ...
        let url="https://newsapi.org/v2/everything?q=microsoft&apiKey=174ebf1a4f354d2694ff1dd5d34e0387"
    ...
    function searchNews(){
        let url=`https://newsapi.org/v2/everything?q=${search}&apiKey=174ebf1a4f354d2694ff1dd5d34e0387`
